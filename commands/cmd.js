eId, fileName);
    ...
    // ==========================================
    // ACTION: INSTALL (Direct Code or URL)
    // ==========================================
    if (action === "install") {
      if (args.length < 2) {
      ...
      // Extract Code or URL from input
...
» 👑 𝗔𝗨𝗧𝗛𝗢𝗥: ${installedCmd.author || "𝆠፝𝐒𝐈𝐘𝐀𝐌-𝐇𝐀𝐒𝗔𝐍 👑"}

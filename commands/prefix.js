...
module.exports = {
  ...
  execute: async (bot, msg, args, { prefix: currentPrefix }) => {
    ...
    const botUsername = config.botUsername || "YourBotUsername"; 
    const ownerUsername = config.ownerUsername || "YourOwnerUsername"; 
    const supportGroup = config.supportGroup || "YourSupportGroup"; // config এ না থাকলে কাস্টম দিন
      ...
      reply_markup: {
        inline_keyboard: [
          [
            ...
            { text: "📜 𝐂𝐌𝐃 𝐋𝐈𝐒𝐓", callback_data: "cmd_list" } // help.js এ এই কলব্যাক হ্যান্ডেল করা আছে
          ],
          [
